...
Starting this project I knew next to nothing about training a machine learning model. I'm a web developer, not really knowledgable in math or data science. As such I'll try and make everything understandable with just general programming knowledge
...
1. Get a ton of images of already graded comics from the internet
2. throw a ton of compute/ML at it
3. combine each
